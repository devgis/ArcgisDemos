...
"esri/tasks/RouteTask"
  ...
  arrayUtils, ColorPicker, CSVLayer, SimpleRenderer, InfoTemplate, urlUtils, scaleUtils, HomeButton, RouteTask
    ...
    ASPGISOBJECT=function GISObject()
    {
        ...
        */
        ...
        //根据卡口ID取得卡口
        function getBayonet(id) {
            for (var i = 0; i < bayonetLayer.graphics.length; i++) {
                if (bayonetLayer.graphics[i].attributes["code"] == id) {
        ...
        function DrawTrackPoint(id) {
            ...
            for (var i = 0; i < points.length; i++) {
                ...
                graphicText.setAttributes({ "id": id, "name": BayonentName }); //"type":"tkpoint"
                trackPointLayer.add(graphicText);
            }
